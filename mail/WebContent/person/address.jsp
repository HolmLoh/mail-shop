		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-address">
					...
					<hr />
					<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails" id="receivingaddressUl">
					...
					<div class="am-modal am-modal-no-btn" id="doc-modal-1">
						...
						<div class="add-dress">
							...
							<!--标题 -->
							<div class="am-cf am-padding" id = "ra_head">
								<div class="am-fl am-cf">
								...
								<form class="am-form am-form-horizontal" id="form1"
									...
									<div class="am-form-group">
										...
										<div class="am-form-content address">
											...
											</select> <select data-am-selected name="province">
									...
									<div class="am-form-group">
										...
										<div class="am-form-content">
											<textarea class="" rows="3" name="user-intro"
									...
									<div class="am-form-group">
										<div class="am-u-sm-9 am-u-sm-push-3">
											<a class="am-btn am-btn-danger" id="btn-save">保存</a>
